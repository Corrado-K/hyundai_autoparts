          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="../action/addProduct.php" class="tm-edit-product-form" method="post" enctype="multipart/form-data" >
              ...
              <div class="col-12">
                <button type="submit" name="addProduct" class="btn btn-primary btn-block text-uppercase">Add Product Now</button>
              </div>
              </form>
            </div>
          </div>
